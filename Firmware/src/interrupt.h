...
#define IRQ_PRIORITY_TIM4           0x03
#define IRQ_PRIORITY_SYSTICK		0x04
#define IRQ_PRIORITY_USART3         0x05
#define IRQ_PRIORITY_ADC            0x06
#define IRQ_PRIORITY_USART1			0x07
